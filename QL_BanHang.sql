...
CREATE PROCEDURE InsertHH
@MaMatHang int output,
...
AS
	INSERT INTO MatHang (MaMatHang, TenMatHang, DonGia, SoLuong, MaNCC, MaLoai)
	VALUES ( @MaMatHang, @TenMatHang,  @DonGia, @SoLuong, @MaNCC, @MaLoai)
	SET IDENTITY_INSERT dbo.MatHang ON

	SELECT @MaMatHang = SCOPE_IDENTITY()
